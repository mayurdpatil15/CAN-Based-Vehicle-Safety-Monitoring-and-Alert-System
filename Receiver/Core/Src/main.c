...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOD, Buzzer_Pin|GPIO_PIN_12|GPIO_PIN_13, GPIO_PIN_RESET);

  /*Configure GPIO pins : Buzzer_Pin PD12 PD13 */
  GPIO_InitStruct.Pin = Buzzer_Pin|GPIO_PIN_12|GPIO_PIN_13;
